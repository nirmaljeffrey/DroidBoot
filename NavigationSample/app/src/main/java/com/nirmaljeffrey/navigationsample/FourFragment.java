...
import com.nirmaljeffrey.navigationsample.databinding.FragmentFourBinding;


public class FourFragment extends BaseFragment<NumberViewModel> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
       ...
       FragmentFourBinding binding =  DataBindingUtil.inflate(inflater, R.layout.fragment_four, container, false);
