...
import com.nirmaljeffrey.navigationsample.databinding.FragmentSevenBinding;

import java.math.BigInteger;


public class SevenFragment extends BaseFragment<NumberViewModel> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentSevenBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_seven, container, false);
