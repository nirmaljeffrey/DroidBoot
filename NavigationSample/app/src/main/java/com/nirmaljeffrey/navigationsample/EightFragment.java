...
import com.nirmaljeffrey.navigationsample.databinding.FragmentEightBinding;


public class EightFragment extends BaseFragment<NumberViewModel> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        FragmentEightBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_eight, container, false);
