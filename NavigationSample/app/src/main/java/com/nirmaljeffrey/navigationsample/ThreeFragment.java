...
import com.nirmaljeffrey.navigationsample.databinding.FragmentThreeBinding;


public class ThreeFragment extends BaseFragment<NumberViewModel> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        FragmentThreeBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_three, container, false);
